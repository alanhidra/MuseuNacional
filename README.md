<h1 align="center">🖼️ Museu Nacional 🖼️</h1>
<p align="center">Este é o repositório do meu sexto projeto de desenvolvimento front-end, um site fictício de um  Museu Nacional. Este projeto foi criado como parte do meu curso de desenvolvimento front-end e utiliza somente HTML, CSS e Bootstrap.  O objetivo deste projeto é criar uma página web responsiva e atraente para um hotel fictício, fornecendo informações sobre as acomodações, localização, serviços e outras informações relevantes para os clientes potenciais.</p>
